...
run-benchmarks:
	...
	python ./cirtorch/examples/test.py --gpu-id '0' --network-path 'retrievalSfM120k-resnet101-gem' --multiscale --datasets 'scores' > ./logs/tuned-resnet-gem.log --whitening 'retrieval-SfM-120k'
	python ./cirtorch/examples/test.py --gpu-id '0' --network-path 'retrievalSfM120k-vgg16-gem' --multiscale --datasets 'scores' > ./logs/tuned-vgg-gem.log --whitening 'retrieval-SfM-120k'
